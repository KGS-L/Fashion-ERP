...
This Django application owns the local customer hierarchy inside one FashionERP ERP Data Plane database.
...
Establishment `site_type` prepares the structural scopes explicitly mentioned by the FashionERP specification: workshop, store and warehouse, while allowing office/mixed/other sites without implementing their business modules prematurely.
