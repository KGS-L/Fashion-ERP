...
urlpatterns = [
    ...
    path("delivery/", include("ivadoo.delivery.urls")),
    path("operations/", include("ivadoo.operations.urls")),
    path("employees/", include("ivadoo.employees.urls")),
    path("crm/", include("ivadoo.crm.urls")),
