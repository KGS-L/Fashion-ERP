...
Versioned Django migrations for the Ivadoo platform extensibility layer: module activation state, customization metadata and related cross-cutting platform records.
