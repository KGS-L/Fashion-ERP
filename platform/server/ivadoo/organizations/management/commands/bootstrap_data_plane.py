...
from ivadoo.organizations.services import provision_local_organization


class Command(BaseCommand):
    help = "Bootstrap the local Ivadoo Data Plane organization and initial user."
    ...
    def handle(self, *args, **options):
        ...
        password = os.getenv("IVADOO_BOOTSTRAP_PASSWORD")
        if not password:
